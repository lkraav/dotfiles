...
awful.rules.rules = {
    ...
    { rule = { class = "Mirage" }, properties = { maximized_vertical = true, maximized_horizontal = true } },
    { rule = { class = "Navigator" }, properties = { tag = tags[1][1], maximized_vertical = true, maximized_horizontal = true } },
    ...
    { rule = { class = "Wpa_gui" }, properties = { floating = true }, callback = awful.placement.centered },
    { rule = { class = "XMind" }, properties = { maximized_vertical = true, maximized_horizontal = true } },
    { rule = { class = "XTerm" }, properties = { size_hints_honor = false } },
    { rule = { instance = "VNC Menu", instance = "VNC authentication [VncAuth]", instance = "VNC Viewer: Information" }, properties = { floating = true, callback = awful.placement.centered } },
    { rule = { instance = "XTerm-logs" }, properties = { tag = tags[1][9] } },
